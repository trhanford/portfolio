(function(){
  ...
  const data = {
    ...
    'bronco-coyote': {
      ...
      gallery: [
        { src: 'images/placeholders/coyote_new_1.jpeg', alt: 'Coyote Bronco body mockup from the front three-quarter angle.' },
        { src: 'images/placeholders/coyote_new_2.jpeg', alt: 'Coyote Bronco engine bay showcasing the 5.0L Coyote installation.' },
        { src: 'images/placeholders/coyote_new_3.jpeg', alt: 'Detailed view of the Bronco front suspension and steering components.' },
        { src: 'images/placeholders/coyote_new_4.jpeg', alt: 'Interior layout of the Coyote Bronco during mockup.' },
        { src: 'images/placeholders/coyote_new_5.jpeg', alt: 'Close-up of the Bronco wiring harness integration.' },
        { src: 'images/placeholders/coyote_new_6.jpeg', alt: 'Bronco chassis setup highlighting drivetrain components.' },
        { src: 'images/placeholders/coyote_new_7.jpeg', alt: 'Fabrication work on the Bronco firewall and accessories.' },
        { src: 'images/placeholders/coyote_new_8.jpeg', alt: 'Undercarriage view of the Bronco exhaust and driveline.' },
        { src: 'images/placeholders/coyote_new_9.jpeg', alt: 'Interior electronics and dashboard progress on the Coyote Bronco.' },
        { src: 'images/placeholders/coyote_new_10.jpeg', alt: 'Bronco exterior in primer with body panel alignment in progress.' },
        { src: 'images/placeholders/coyote_new_11.jpeg', alt: 'Custom brake and suspension hardware installed on the Bronco.' },
        { src: 'images/placeholders/coyote_new_12.jpeg', alt: 'Engine bay wiring cleanup around the Coyote powerplant.' },
        { src: 'images/placeholders/coyote_new_13.jpeg', alt: 'Bronco interior trim test fit during the build.' },
        { src: 'images/placeholders/coyote_new_14.jpeg', alt: 'Rear cargo area layout with electrical components staged.' },
        { src: 'images/placeholders/coyote_new_15.jpeg', alt: 'Coyote Bronco stance captured from the rear three-quarter view.' },
    ...
    'jeep-cj5': {
      ...
      gallery: [
        ...
        { src: 'images/placeholders/jeep_new_1.jpeg', alt: 'Jeep Addition' },
        { src: 'images/placeholders/jeep_new_2.jpeg', alt: 'Jeep addition' },
        { src: 'images/placeholders/jeep_new_3.jpeg', alt: 'Jeep addition' },
        { src: 'images/placeholders/jeep_new_4.jpeg', alt: 'Jeep addition' },
        { src: 'images/placeholders/jeep_new_5.jpeg', alt: 'Jeep addition' },
        { src: 'images/placeholders/jeep_new_6.jpeg', alt: 'Jeep addition' },
        { src: 'images/placeholders/jeep_new_7.jpeg', alt: 'Jeep addition.' },
        { src: 'images/placeholders/jeep_new_8.jpeg', alt: 'Jeep addition' }
      ],
    },
    'cad-butterfly-valve': {
